...
localparam TOTAL_LINES      = IMG_HEIGHT * IMG_WIDTH * 3 / PIXELS_PER_LINE;     // 总行数
        ...
        case (state)
            ...
            S_READ: begin
                if (ddr3_cmd_ready && fifo_wr_num < WR_PER_LINE) begin
                    ...
                    read_cmd_cnt <= read_cmd_cnt + 9'd1; // 命令计数
                    current_src_addr <= current_src_addr + ADDR_INCREMENT; // 地址递增
